...
public class TekeningTest {
    ...
    @Test(expected = DomainException.class)
    public void voegToe_moet_exception_gooien_als_vorm_al_in_de_lijst_staat() {
    ...
    @Test
    public void voegToe_moet_vorm_toevoegen_als_deze_nog_niet_in_de_lijst_staat() {
        Tekening tekening = new Tekening("Mooie Tekening");
        tekening.voegToe(rechthoek);
    }

    @Test(expected = DomainException.class)
    public void getVorm_met_een_index_groter_dan_size_van_lijst_gooit_exception() {
        Tekening tekening = new Tekening("Mooie Tekening");
        tekening.getVorm(15);
    }

    @Test
    public void getVorm_met_een_index_binnen_de_size_van_lijst_geeft_vorm_terug() {
        Tekening tekening = new Tekening("Mooie Tekening");
        tekening.voegToe(rechthoek);
        tekening.getVorm(0);
    }
    ...
    @Test(expected = DomainException.class)
    public void verwijder_een_vorm_dat_niet_in_de_lijst_staat_gooit_exception() {
        Tekening tekening = new Tekening("Mooie Tekening");
        tekening.verwijder(rechthoek);
    }

    @Test
    public void verwijder_een_vorm_dat_in_de_lijst_staat_lukt() {
        Tekening tekening = new Tekening("Mooie Tekening");
        tekening.voegToe(rechthoek);
        tekening.verwijder(rechthoek);
    }
