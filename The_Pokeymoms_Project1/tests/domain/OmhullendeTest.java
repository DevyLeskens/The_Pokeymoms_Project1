...
public class OmhullendeTest {
    ...
    @Test
    public void getMinimumX_moet_dezelfde_waarde_zijn() {
        assertEquals(omhullende.getMinimumX(), linkerBovenhoek.getX());
    }

    @Test
    public void getMinimumY_moet_dezelfde_waarde_zijn() {
        assertEquals(omhullende.getMinimumY(), linkerBovenhoek.getY());
    }

    @Test
    public void getMaximumX_moet_dezelfde_waarde_zijn() {
        assertEquals(omhullende.getMaximumX(), linkerBovenhoek.getX() + breedte);
    }

    @Test
    public void getMaximumY_moet_dezelfde_waarde_zijn(){
